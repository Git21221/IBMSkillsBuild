...
const material = new THREE.MeshBasicMaterial({map: new THREE.TextureLoader().load('images/5672_mars_12k_color.jpg')}); //material
...
const hdrTexture = new URL('../../low-angle-shot-mesmerizing-starry-sky.hdr', import.meta.url);
