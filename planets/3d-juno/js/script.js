...
loader.load('images/juno_obj_transparent.glb', function (glb) {
    console.log(glb)
...
const light1 = new THREE.DirectionalLight(0x404040, 30);
const light2 = new THREE.DirectionalLight(0x404040, 30);
const light3 = new THREE.DirectionalLight(0x404040, 30);
const light4 = new THREE.DirectionalLight(0x404040, 30);
const light5 = new THREE.DirectionalLight(0x404040, 30);
// for light
